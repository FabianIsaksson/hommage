...
export type Panes = { brandLogo: string; names: string[]; image: string }[];
  ...
  return (
    <div className="App">
      <div className="vertical-panes">
        {panes.map(({ brandLogo, names, image }, index) => (
          <div
            key={brandLogo}
          ...
          >
            ...
            <div
              ...
              className="vertical-panes-copy"
            >
              <div className="vertical-panes-logo">
                <img
                  className="vertical-panes-logo-image"
                  alt="vertical-panes-logo"
                  src={brandLogo}
                ></img>
              </div>
              <div className="vertical-panes-frame-names">
                {names.map((name) => (
                  <p className="vertical-panes-frame-names-name">{name}</p>
                ))}
              </div>
            </div>
          </div>
