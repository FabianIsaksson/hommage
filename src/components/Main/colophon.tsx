          ...
          <div className="section">
            <div className="part">
              ...
              <ul>
                ...
                <li>Gunilla Pontén</li>
                <li>Sighsten Herrgård</li>
              </ul>
            </div>
            <div className="part">
              ...
              <ul>
                ...
                <li>Asli Cömert </li>
                <li>Desirée Bjurinder Fritzon</li>
                <li>Gabriella Danerlöv</li>
                <li>Hilda Landström Ferm</li>
                <li>Isabelle Sjöman</li>
                <li>Kevin Nilsson </li>
                <li>Maya Sundholm</li>
